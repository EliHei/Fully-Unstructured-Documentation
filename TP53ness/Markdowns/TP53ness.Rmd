...
feature.df$nut <- ifelse(feature.df$Nutlin.3a > 0.9, 2, 1)
...
params <- list()
params$TP53 <- list(name = "TP53", fdf = feature.df, dds = dds, design.formula = ~ TP53)
...
params$nut.res <- list(name = "nut.res", fdf = fdf, dds = dds2, design.formula = ~ nut.res)
